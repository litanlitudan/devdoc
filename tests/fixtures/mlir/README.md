...
_Note: Please make sure OpenCV, libjpeg-dev and libpng-dev is installed to play around._
...
_Note: Maximum allowed value of `BUDDY_DIP_OPT_STRIP_MINING` for producing correct result is equal to image width._
...
_Note: No external library required._
